...
class Fighter(pygame.sprite.Sprite):
    ...
    def __init__(self, x=320, y=240, i=0):
        """create a fighter"""
        self._layer = 4   #self.layer = layer
        pygame.sprite.Sprite.__init__(self, self.groups) #call parent class. NEVER FORGET !
        self.i= i
        self.image=Fighter.images[i]
...
class PygView(object):
    ...
    def __init__(self, width=640, height=400, fps=30):
        ...
        self.background=pygame.image.load(os.path.join("data","zacken.jpg"))
        self.background.convert()
        Fighter.images.append(pygame.image.load(os.path.join("data","links.png")).convert_alpha())
        Fighter.images.append(pygame.image.load(os.path.join("data","rechts.png")).convert_alpha())
    ...
    def paint(self):
        ...
        Fighter.groups = self.allgroup, self.fightergroup
        self.ball1 = Ball(x=100, y=100) # creating a Ball Sprite
        self.ball2 = Ball(x=200, y=100) # create another Ball Sprite
        self.links = Fighter(x = 100, y = 200, i = 0)
        self.rechts = Fighter(x = 500, y = 200, i=1)
    ...
    def run(self):
        ...
        while running:
            ...
            write(self.screen, "Press b to add another Ojtejzk6ze3ueeeeeeeeeeeeeeeeeeeeeeeeekqlllltkjzkw4otj4wit",x=self.width//2, y=250, center=True)
